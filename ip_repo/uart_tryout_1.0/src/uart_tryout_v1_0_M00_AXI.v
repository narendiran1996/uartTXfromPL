...
`timescale 1 ns / 1 ps
	...
	module uart_tryout_v1_0_M00_AXI #
	(
	...
	assign M_AXI_AWADDR	= address_write_value + axi_awaddr;
	//AXI 4 write data
	...
	//Read Address (AR)
	assign M_AXI_ARADDR	= address_read_value + axi_araddr;
...
//	              end    
	...
	// Add user logic here
	assign dstatus = {axi_arvalid , M_AXI_RVALID, last_read, start_single_read, read_issued};
        always @(posedge M_AXI_ACLK)                                                      
            begin                                                                             
                if (M_AXI_ARESETN == 0 || init_txt_pulse == 1'b1)          
                    begin                                               
